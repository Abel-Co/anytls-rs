...
cargo run --bin anytls-server -- -l 0.0.0.0:8443 -p testpass &
SERVER_PID=$!
...
cargo run --bin anytls-client -- -l 0.0.0.0:1081 -s 172.17.16.174:8443 -p testpass &
CLIENT_PID=$!
