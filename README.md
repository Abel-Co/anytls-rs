...
A Rust implementation of the AnyTLS proxy protocol, "that attempts to mitigate the TLS in TLS fingerprinting problem", and can be cross-used with anytls-go's server and client. (Version 0.0.12 has been tested)
